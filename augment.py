...
if __name__ == '__main__':
    ...
    os.makedirs("./lung_nodule_dataset/BMP_ALL/imgs", exist_ok=True)
    os.makedirs("./lung_nodule_dataset/BMP_expand/augment_img_rotate", exist_ok=True)
    os.makedirs("./lung_nodule_dataset/BMP_expand/all_anno_3D.csv", exist_ok=True)
    os.makedirs("./lung_nodule_dataset/BMP_expand/augment_rotate.csv", exist_ok=True)
    parser.add_argument('--data-path', type=str,
                        default='./lung_nodule_dataset/BMP_ALL/imgs')
    parser.add_argument('--output-path', type=str,
                        default='./lung_nodule_dataset/BMP_expand/augment_img_rotate')
    parser.add_argument('--csv-dir', type=str,
                        default='./lung_nodule_dataset/BMP_expand/all_anno_3D.csv')
    parser.add_argument('--csv-save', type=str,
                        default='./lung_nodule_dataset/BMP_expand/augment_rotate.csv')
